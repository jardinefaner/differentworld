  ...
  return pw.Column(
    ...
    children: [
      ...
      pw.Text(
        ...
        '${book.weeks.length} ${book.weeks.length == 1 ? 'world' : 'worlds'} visited',
      ...
      pw.Container(
        ...
        child: pw.Text(
          _ascii('A summer of becoming — the worlds ${book.firstName} '
  ...
  return pw.Container(
    ...
    child: pw.Column(
      ...
      children: [
        ...
        pw.SizedBox(height: 4),
        pw.Text(
          _ascii('${book.weeks.length} worlds, ${book.days} days, and a '
