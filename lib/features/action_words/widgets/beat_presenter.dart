...
class _BeatPresenterState extends ConsumerState<BeatPresenter> {
  ...
  Widget build(BuildContext context) {
    ...
    // A beat deck is slideshow-shaped and is often driven from a laptop
    // wired to the TV, where the natural remote is the keyboard — not
    // reaching across to tap the screen the room is watching. → / Enter
    // advance, ← goes back, exactly like the reveal games already do
    // (docs/PLATFORM_RUBRIC.md P3). No-op on a touch device.
