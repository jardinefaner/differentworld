...
void main() {
  group('scrubOtherNames', () {
    ...
    test('is case-insensitive', () {
      ...
      expect(
        scrubOtherNames('played w/ sofia', {'Sofia'}),
        'played w/ a friend',
      );
    });
    ...
    test('matches on word boundaries — never a substring of another word', () {
      ...
      expect(
        scrubOtherNames('the sofiana plant', {'Sofia'}),
        'the sofiana plant',
      );
    ...
    test('scrubs the possessive form too ("Sofia\'s" → "a friend\'s")', () {
      expect(
        scrubOtherNames("Sofia's idea grew", {'Sofia'}),
        "a friend's idea grew",
      );
    });
  ...
  group('anonymizeSummerBook', () {
    ...
    test(
      'drops every other-child name across milestone, ally, and moments',
      () {
        ...
        expect(
          w.moments.first,
          'a friend and a friend built a fort with Mateo',
        );
    ...
    test(
      'ACCEPTANCE: an exported book contains NO other child name anywhere',
      () {
        final safe = anonymizeSummerBook(fixture(), {'Sofia', 'Aiden'});
