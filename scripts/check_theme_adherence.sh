...
ALLOW='^lib/app/theme\.dart$|^lib/app/design_tokens\.dart$|^lib/features/settings/outdoor_mode_setting\.dart$|_pdf\.dart$|/templates/[^/]+\.dart$|^lib/features/poster/poster_engine\.dart$|^lib/features/live_session/|^lib/features/speak/|^lib/features/games/games/|^lib/features/games/game_fullscreen\.dart$|^lib/features/action_words/world_present_screen\.dart$|^lib/features/action_words/world_cast_game\.dart$|^lib/features/action_words/conductor\.dart$|^lib/features/action_words/widgets/beat_presenter\.dart$|^lib/features/activity_runtime/photography_runner_screen\.dart$|^lib/features/vehicles/guided_capture_screen\.dart$|^lib/features/photos/widgets/multi_shot_camera\.dart$|^lib/features/vehicles/vehicle_scan_screen\.dart$'
