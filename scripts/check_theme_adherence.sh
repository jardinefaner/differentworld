...
ALLOW='^lib/app/theme\.dart$|^lib/app/design_tokens\.dart$|^lib/features/settings/outdoor_mode_setting\.dart$|_pdf\.dart$|/templates/[^/]+\.dart$|^lib/features/poster/poster_engine\.dart$|^lib/features/poster/poster_screen\.dart$|^lib/features/live_session/cast_stage_chrome\.dart$|^lib/features/live_session/cast_receiver\.dart$|^lib/features/live_session/board_screen\.dart$|^lib/features/live_session/live_game_screen\.dart$|^lib/features/live_board/board_game\.dart$|^lib/features/speak/|^lib/features/games/game\.dart$|^lib/features/games/game_stage\.dart$|^lib/features/games/games/|^lib/features/games/game_fullscreen\.dart$|^lib/features/activity_runtime/discussions_screen\.dart$|^lib/features/action_words/world_present_screen\.dart$|^lib/features/action_words/world_cast_game\.dart$|^lib/features/action_words/conductor\.dart$|^lib/features/action_words/widgets/beat_presenter\.dart$|^lib/features/action_words/widgets/present_stage\.dart$|^lib/features/action_words/widgets/block_handoff\.dart$|^lib/features/action_words/reveal_overlay\.dart$|^lib/features/action_words/journey_tour_screen\.dart$|^lib/features/action_words/growth_arc_screen\.dart$|^lib/features/action_words/activity_arc_screen\.dart$|^lib/features/action_words/day_run_screen\.dart$|^lib/features/missions/mission_do_screen\.dart$|^lib/features/activity_runtime/photography_runner_screen\.dart$|^lib/features/activity_runtime/breathe_screen\.dart$|^lib/features/activity_runtime/kid_mode_lock\.dart$|^lib/features/action_words/kid_job_screen\.dart$|^lib/features/action_words/action_words_kid_screen\.dart$|^lib/features/spells/spell_overlay\.dart$|^lib/features/world/draw_self_screen\.dart$|^lib/features/vehicles/guided_capture_screen\.dart$|^lib/features/photos/widgets/multi_shot_camera\.dart$|^lib/shared/widgets/camera_chrome\.dart$|^lib/features/photos/widgets/photo_viewer\.dart$|^lib/features/vehicles/vehicle_scan_screen\.dart$|^lib/shared/widgets/horizon_mark\.dart$|^lib/shared/widgets/generated_portrait\.dart$|^lib/shared/widgets/drawing_pad\.dart$|^lib/features/schedule/block_present_screen\.dart$|^lib/features/story/story_showcase_screen\.dart$|^lib/features/live_session/slide_present\.dart$'
