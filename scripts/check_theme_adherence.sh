...
ALLOW='^lib/app/theme\.dart$|^lib/app/design_tokens\.dart$|^lib/features/settings/outdoor_mode_setting\.dart$|_pdf\.dart$|/templates/[^/]+\.dart$|^lib/features/poster/poster_engine\.dart$|^lib/features/poster/poster_screen\.dart$|^lib/features/live_session/|^lib/features/live_board/board_game\.dart$|^lib/features/speak/|^lib/features/games/games/|^lib/features/games/game_fullscreen\.dart$|^lib/features/action_words/world_present_screen\.dart$|^lib/features/action_words/world_cast_game\.dart$|^lib/features/action_words/conductor\.dart$|^lib/features/action_words/widgets/beat_presenter\.dart$|^lib/features/action_words/reveal_overlay\.dart$|^lib/features/action_words/journey_tour_screen\.dart$|^lib/features/action_words/growth_arc_screen\.dart$|^lib/features/action_words/day_run_screen\.dart$|^lib/features/missions/mission_do_screen\.dart$|^lib/features/activity_runtime/photography_runner_screen\.dart$|^lib/features/activity_runtime/breathe_screen\.dart$|^lib/features/activity_runtime/kid_mode_lock\.dart$|^lib/features/spells/spell_overlay\.dart$|^lib/features/world/draw_self_screen\.dart$|^lib/features/vehicles/guided_capture_screen\.dart$|^lib/features/photos/widgets/multi_shot_camera\.dart$|^lib/features/photos/widgets/photo_viewer\.dart$|^lib/features/vehicles/vehicle_scan_screen\.dart$|^lib/shared/widgets/horizon_mark\.dart$'
...
while IFS= read -r f; do
  ...
  hits=$(printf '%s\n' "$added" \
    | grep -vE 'Colors\.transparent|\.withValues\(' \
