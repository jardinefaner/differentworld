...
- Omnibox: `page.action-words` — "Action Words" (keywords: verbs, words, worlds, pick, reveal, collection, animal; morning contextTag). `page.different-worlds` — "Different Worlds" (keywords: books, movies, songs, dreams, space, time, different world, room). No omnibox entries for `/send`, `/worlds`, or `/activities` — reached via chrome action buttons or in-context links.
- Slash: none
...
**Status**: building — core 4-step loop shipped (waves 1–4); Send home + world book shipped (wave 5); themed world of the week shipped as wave 6 (route + omnibox renamed to Different Worlds gallery in af7ed97). Next: activity matcher verb-tagging library hookup, today dashboard (word-of-day + kid cards), spell timers.
