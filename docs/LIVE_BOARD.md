...
- **Sound it out** — type a word split with hyphens (but-ter-fly); tap to light each chunk, then blend (phonics).
...
- show-and-tell (push a kid's drawing/work photo) · spotlight/point at an
  image · attention-cue · hold/freeze.
